...
public class Parent {
    public WebDriverWait wait = new WebDriverWait(DR.getDriver(), Duration.ofSeconds(20));
    Actions actions = new Actions(DR.getDriver());
    ...
    public void scrollToElement(WebElement element) {
        JavascriptExecutor js = (JavascriptExecutor) DR.getDriver();
    ...
    public void verifyContainsText(WebElement element, String value) {
        ...
        new Actions(DR.getDriver()).sendKeys(Keys.ESCAPE).build().perform();
    }
